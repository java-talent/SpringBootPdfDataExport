...
import com.javatalent.service.IInvoiceService;
import com.javatalent.view.InvoiceDataPdfExport;
...
public class InvoiceController {
	...
	*/
	/*
	 * @GetMapping("/pdf") public ModelAndView exportToPdf() { ModelAndView mav =
	 * new ModelAndView(); mav.setView(new InvoiceDataPdfExport()); //read data from
	 * DB List<Invoice> list= service.getAllInvoices(); //send to pdfImpl class
